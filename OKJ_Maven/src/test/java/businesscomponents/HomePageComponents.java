...
public class HomePageComponents extends ReusableLibrary {
	...
	public void verifyHeaderLinkNavigation() {
		try {
			...
			commonFunction.verifyIfElementPresent(getPageElement(HomePageObjects.lnkNaviSmokerAndGrills),
					HomePageObjects.lnkNaviSmokerAndGrills.getObjectname());
			commonFunction.verifyIfElementPresent(getPageElement(HomePageObjects.lnkNaviAccessoriesAndParts),
					HomePageObjects.lnkNaviAccessoriesAndParts.getObjectname());
			commonFunction.verifyIfElementPresent(getPageElement(HomePageObjects.lnkNaviTheCraft),
					HomePageObjects.lnkNaviTheCraft.getObjectname());
			commonFunction.verifyIfElementPresent(getPageElement(HomePageObjects.lnkNaviOurStory),
	...
	public void validateCategoryLandingPageSmokersGrills() {
		try {
			...
			commonFunction.verifyIfElementPresent(getPageElement(HomePageObjects.txtTitleSmokersGrills),
