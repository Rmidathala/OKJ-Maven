...
public class PartListingPageScenario extends ReusableLibrary {
	...
	public void validatePartDetailsPage() {
		try {
			...
			commonFunction.verifyIfElementIsPresent(getPageElement(PartListingPageObjects.btnPartAddToCartButton), PartListingPageObjects.btnPartAddToCartButton.getObjectname());
